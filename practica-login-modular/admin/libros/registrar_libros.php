    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" href="./registrar_libros.php">Registrar Productos</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="./form-registro.php">Registrar Usuarios</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="./administrar_libros.php">Administrar Productos</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="../../includes/cerrar_session.php">Cerrar sesion</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="formRegistro" action="crear_libros.php" method="post" enctype="multipart/form-data">
